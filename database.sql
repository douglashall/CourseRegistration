...
create table registration_student (id number(19,0) not null, degree_year number(19,0) not null, program_department varchar2(255) not null, user_id varchar2(255) not null, primary key (id));
create table student_course (id number(19,0) not null, active number(10,0) not null, course_instance_id number(19,0) not null, date_created date not null, grading_option varchar2(255), home_school_id varchar2(255), last_updated date not null, level_option varchar2(255), registration_context_id number(19,0), user_id varchar2(255) not null, primary key (id));
